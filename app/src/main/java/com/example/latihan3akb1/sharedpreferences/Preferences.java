package com.example.latihan3akb1.sharedpreferences;
...
public class Preferences {
    ...
    private static final String PREF_SESSION = "com.example.latihan3akb1.session";
    ...
    public static void setUserPreferences(Context context, User user) {
        ...
        editor.putString(REGISTER_PHONE, user.getPhone());
        editor.apply();
    }
